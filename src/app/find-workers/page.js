...
const MOCK_WORKERS = [
  {
    ...
    portfolio: [
      ...
      'https://images.unsplash.com/photo-1558402529-d2638a7023e9?w=400&h=400&fit=crop',
      'https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?w=400&h=400&fit=crop',
      'https://images.unsplash.com/photo-1581092921461-eab62e97a783?w=400&h=400&fit=crop',
    ],
    comments: [
      { id: 'c1', name: 'Sarah Parker', email: 'sarah@example.com', rating: 5, text: 'Alex did an amazing job rewiring our kitchen. Very professional and clean work!', date: 'Oct 15, 2023' },
      { id: 'c2', name: 'Mike Ross', email: 'mike@example.com', rating: 4, text: 'Great work, arrived on time. Slightly over budget but worth it.', date: 'Sep 28, 2023' },
    ],
  },
  // boshqa workers...
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <AnimatePresence mode="popLayout">
            {filteredWorkers.map((worker) => (
              ...
              >
                <WorkerCard worker={worker} onClick={() => setSelectedWorker(worker)} />
              </motion.div>
            ))}
          </AnimatePresence>
        </div>
                      ...
                      <div className="p-8 md:w-1/3 border-b md:border-b-0 md:border-r border-gray-200/50 bg-white/40">
                        <div className="text-center md:text-left">
                          ...
                          <div className="space-y-3 text-gray-600 mb-8">
                            ...
                            <div className="flex items-center justify-center md:justify-start gap-2">
                              <Briefcase size={18} />
                              <span>{selectedWorker.portfolio.length} Projects Completed</span>
                            </div>
                          </div>
